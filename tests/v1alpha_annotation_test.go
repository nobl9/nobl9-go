	...
	annotations := []v1alphaAnnotation.Annotation{
		v1alphaAnnotation.New(
			...
			v1alphaAnnotation.Spec{
				...
				EndTime:       ptr(mustParseTime("2024-05-04T10:00:00Z").UTC()),
		...
		v1alphaAnnotation.New(
			...
			v1alphaAnnotation.Spec{
				...
				EndTime:     ptr(mustParseTime("2024-05-16T15:00:00Z").UTC()),
				Category:    v1alphaAnnotation.CategoryComment,
			},
		),
		v1alphaAnnotation.New(
			...
			v1alphaAnnotation.Spec{
				...
				EndTime:     ptr(mustParseTime("2024-05-17T15:00:00Z").UTC()),
				Category:    v1alphaAnnotation.CategoryComment,
			},
		),
		v1alphaAnnotation.New(
			...
			v1alphaAnnotation.Spec{
				...
				EndTime:     ptr(mustParseTime("2024-05-18T15:00:00Z").UTC()),
				Category:    v1alphaAnnotation.CategoryComment,
			},
		),
	}
