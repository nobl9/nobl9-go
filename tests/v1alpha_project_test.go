...
func Test_Objects_V1_V1alpha_Project(t *testing.T) {
	...
	testutils.V1Apply(t, inputs)
	t.Cleanup(func() { testutils.V1Delete(t, inputs) })
...
func newV1alphaProject(
	...
	return v1alphaProject.New(metadata, v1alphaProject.Spec{Description: testutils.GetObjectDescription()})
}

func generateV1alphaProject(t *testing.T) v1alphaProject.Project {
	t.Helper()
	return newV1alphaProject(t, v1alphaProject.Metadata{Name: testutils.GenerateName()})
}
