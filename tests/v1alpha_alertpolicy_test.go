...
func Test_Objects_V1_V1alpha_AlertPolicy(t *testing.T) {
	...
	examples := e2etestutils2.GetAllExamples(t, manifest.KindAlertPolicy)
...
func newV1alphaAlertPolicy(
	...
	t.Helper()
	metadata.Labels = e2etestutils2.AnnotateLabels(t, metadata.Labels)
	metadata.Annotations = commonAnnotations
	ap := e2etestutils2.GetExampleObject[v1alphaAlertPolicy.AlertPolicy](t,
