...
// StringName ensures the property's value is a valid name following DNS label rules with extended length (up to 253 characters).
// It follows the same rules as StringDNSLabel but allows up to 253 characters instead of 63.
