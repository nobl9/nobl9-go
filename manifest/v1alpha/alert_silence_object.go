...
func (a AlertSilence) SetProject(project string) AlertSilence {
...
func (a AlertSilence) SetOrganization(org string) AlertSilence {
	a.Organization = org
	return a
}
...
func (a AlertSilence) SetManifestSource(src string) AlertSilence {
