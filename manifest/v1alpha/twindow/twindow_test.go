...
func TestGetTimePeriod(t *testing.T) {
	...
	t.Run("calendar time window", func(t *testing.T) {
		...
		testCases := []struct {
			...
			{
				name:          "PC-16593 March 31st - 1 Month = March 3rd, 1 second before",
				unit:          Month,
				count:         1,
				startTime:     "2025-03-31 00:00:00",
				timeZone:      "UTC",
				timestamp:     "2025-03-02T23:59:59Z",
				expectedBegin: "2025-01-31T00:00:00Z",
				expectedEnd:   "2025-03-03T00:00:00Z",
			},
			{
				name:          "PC-16593 March 31st - 1 Month = March 3rd, exactly at",
				unit:          Month,
				count:         1,
				startTime:     "2025-03-31 00:00:00",
				timeZone:      "UTC",
				timestamp:     "2025-03-03T00:00:00Z",
				expectedBegin: "2025-03-03T00:00:00Z",
				expectedEnd:   "2025-03-31T00:00:00Z",
			},
			{
				name:          "PC-16593 March 31st - 4 Months = Dec 1st, 1 second before",
				unit:          Month,
				count:         1,
				startTime:     "2025-03-31 00:00:00",
				timeZone:      "UTC",
				timestamp:     "2024-11-30T23:59:59Z",
				expectedBegin: "2024-10-31T00:00:00Z",
				expectedEnd:   "2024-12-01T00:00:00Z",
			},
			{
				name:          "PC-16593 March 31st - 4 Months = Dec 1st, exactly at",
				unit:          Month,
				count:         1,
				startTime:     "2025-03-31 00:00:00",
				timeZone:      "UTC",
				timestamp:     "2024-12-01T00:00:00Z",
				expectedBegin: "2024-12-01T00:00:00Z",
				expectedEnd:   "2024-12-31T00:00:00Z",
			},
			{
				name:          "PC-16593 January 31st + 1 Month = March 3rd",
				unit:          Month,
				count:         1,
			...
			{
				name:          "PC-16593 March 31st + 1 Month = May 1st",
				unit:          Month,
				count:         1,
				startTime:     "2025-03-31 00:00:00",
				timeZone:      "UTC",
				timestamp:     "2025-04-30T23:59:59Z",
				expectedBegin: "2025-03-31T00:00:00Z",
				expectedEnd:   "2025-05-01T00:00:00Z",
			},
			{
				name:          "PC-16593 March 31st + 2 Months = May 31st",
				unit:          Month,
				count:         1,
				startTime:     "2025-03-31 00:00:00",
				timeZone:      "UTC",
				timestamp:     "2025-05-01T00:00:01Z",
				expectedBegin: "2025-05-01T00:00:00Z",
				expectedEnd:   "2025-05-31T00:00:00Z",
			},
			{
				name:          "PC-16593 March 31st + 3 Months = June 1st",
				unit:          Month,
				count:         1,
				startTime:     "2025-03-31 00:00:00",
				timeZone:      "UTC",
				timestamp:     "2025-05-31T00:00:01Z",
				expectedBegin: "2025-05-31T00:00:00Z",
				expectedEnd:   "2025-07-01T00:00:00Z",
			},
			{
				name:          "PC-16593 March 31st + 4 Months = June 31st",
				unit:          Month,
				count:         1,
				startTime:     "2025-03-31 00:00:00",
				timeZone:      "UTC",
				timestamp:     "2025-07-01T00:00:01Z",
				expectedBegin: "2025-07-01T00:00:00Z",
				expectedEnd:   "2025-07-31T00:00:00Z",
			},
		}
